...
import com.nfc_mifareclassic.api.Common;
import com.nfc_mifareclassic.api.NFC_Mifare_classic;
import com.nfc_mifareclassic.api.TagActionException;
...
public class ReadActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		linearLayout.setBackgroundColor(0xFFecf0f1);
		// L1
		...
		buttonSector.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (((Spinner) findViewById(1)).getSelectedItem() != null) {
					...
					String result1="";
					if(result.length()>=32){
					for(int i=0;i<=result.length()-32; i=i+32){
						 result1 += result.substring(i,i+32)+"\n";
					}
					}
